    ...
    companion object {
        val allRanks by lazy {
            listOf(
                ...
                Rank(5, R.string.rank_expert, 100, R.raw.mathhero_5),
                Rank(6, R.string.rank_master, 150, R.raw.mathhero_6),
                Rank(7, R.string.rank_grandmaster, 250, R.raw.mathhero_7),
                Rank(8, R.string.rank_legend, 400, R.raw.mathhero_8),
                Rank(9, R.string.rank_mythic, 600, R.raw.mathhero_9),
                Rank(10, R.string.rank_titan, 1000, R.raw.mathhero_10)
            )
        }
